...
**DISCLAIMER**: The initial version was generated by Claude Code, using Opus 4.5, The prompt generating this project can be
found in prompt.txt, I am unsure it is useful but in the spirit of open source I add it (yes, I know LLMs are far from the
spirit of... well pretty much anything). The code was later modified by me but to be fair, despite the excess of interface 
use by the LLM it is quite decent, especially given the lack of complexity and rather tedious nature of the project.
